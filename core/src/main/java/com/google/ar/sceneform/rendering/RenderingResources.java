...
final class RenderingResources {
    ...
    private static int GetSceneformSourceResource(Context context, Resource resource) {
        switch (resource) {
            ...
            case ADVANCED_OPAQUE_COLORED_MATERIAL:
                return LoadHelper.rawResourceNameToIdentifier(context, "sceneform_advanced_opaque_colored_material");
        }
        return 0;
    }
    ...
    public static enum Resource {
        ...
        ADVANCED_OPAQUE_COLORED_MATERIAL,
